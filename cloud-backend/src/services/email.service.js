...
export const sendPasswordResetEmail = async (email, otp) => {
  const mailOptions = {
    ...
    to: email,
    subject: 'Nirikshan Cloud - Your Password Reset OTP Code',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 24px; border: 1px solid #273449; border-radius: 12px; background-color: #070B14; color: #cbd5e1;">
        ...
        <p style="font-size: 14px; line-height: 1.6;">You requested a password reset for your Nirikshan Cloud account. Please use the verification code below to set a new password:</p>
        ...
        <p style="color: #64748b; font-size: 12px; margin-bottom: 0;">If you did not request a password reset, please ignore this message or contact your system administrator.</p>
      </div>
    `,
  };
